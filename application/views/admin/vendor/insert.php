		...
		<div class="content-wrapper">
		    ...
		    <section class="content-header">
		        ...
		        <ol class="breadcrumb">
		            ...
		            <li class="active">Insert Categories</li>
		        </ol>
		    </section>
		            ...
		            <div class="col-lg-6">
		                ...
		                <div class="box box-primary">
		                    <div class="box-header with-border">
		                        <h3 class="box-title">Insert Categories</h3>
		                    </div>
                            <!-- /.box-header -->
		                    ...
		                    <?php echo form_open_multipart('admin/categories/insert');?>
		                        <div class="box-body">
		                            <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="nama_kategori" id="nama_kategori" placeholder="Nama Kategori" value="<?php echo set_value('nama_kategori') ?>" autocomplete="off">
